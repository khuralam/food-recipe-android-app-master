...
import ca.mohawk.foodrecipeapp.Models.ExtendedIngredient;
...
public class IngredientsAdapter  extends RecyclerView.Adapter<IngredientsViewHolder>{
    ...
    public void onBindViewHolder(@NonNull IngredientsViewHolder holder, int position) {
        ...
        Picasso.get().load("http://spoonacular.com/cdn/ingredients_100*100/"+list.get(position).image).into(holder.imageView_ingredients);
    }
